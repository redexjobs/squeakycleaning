...
@section('content')
				...
				<div class="row mt-3">
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							@endif
							<form role="form" action="{{ asset('admin/edit_blog_category_action') }}" method="POST" enctype='multipart/form-data'> 
							    @CSRF
								...
								<div class="box-body"> 
									...
									<div class="form-group">
										...
										<textarea name="description" id="catDescription" rows="5" class="form-control @error('description') is-invalid @enderror" id="exampleInputEmail1" placeholder="Description" required>{{ $categoryInfo->description }}</textarea>
										@error('description')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
	...
	<script>
		CKEDITOR.replace('catDescription');
	</script>
@endsection

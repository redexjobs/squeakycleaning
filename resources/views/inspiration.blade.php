...
<main role="main" class="middle-content-area">
	<section class="SC-NavigationStyled py-4">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<ul>
						<li class="active"><a href="{{ url('/inspiration') }}">Inspiration</a></li>
						...
						<li><a href="{{ url('/professional-services') }}">Professional services</a></li>
	...
	<section class="SC-HomePageHeroStyled py-5">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<div class="row">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="gray-bg p-4">
								<h5 class="mb-3">Looking for expert help?</h5>
								<a class="red-btn" type="button">Get free quotes</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9 col-8">
					<div class="row">
						<div class="col-md-12">
							<h3><a href="{{ url('/') }}">Indoor projects</a></h3>
						</div>
					</div>
				</div>	

...
@section('title', 'Outdoor projects')
@section('content')
<!-- Main Area Start -->
			...
			<div class="row">
				<div class="col-md-12">
					<ul>
						...
						<li class="active"><a href="{{ url('/outdoor-projects') }}">Outdoor projects</a></li>
				...
				<div class="col-md-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-12 col-sm-12">
					<nav aria-label="breadcrumb" id="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Outdoor projects</li>
						</ol>
					</nav>
					<h1>Outdoor projects</h1>
				</div>
			</div>	
		</div>	
	</section>
